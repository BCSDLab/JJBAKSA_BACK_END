...
public class UserRequest {
    @ApiModelProperty(example="1~20글자의 영문자 및 숫자 ex) test123")
    ...
    @ApiModelProperty(example="영문자, 숫자, 특수문자를 포함하는 8~16의 문자열 ex) test1234!")
