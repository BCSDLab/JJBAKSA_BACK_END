insert into image (id, path, created_at, updated_at, is_deleted, original_name, url) values
    (1, 'path', now(), now(), 0,'origin', 'urltes');
-- 테스트 계정
...
insert into follow(id, user_id, follower_id, created_at, is_deleted, updated_at) values(1, 1, 2, now(), 0, now());

insert into user_count(user_id, review_count, friend_count, scrap_count) values(1, 4, 4, 0);
insert into user_count(user_id, review_count, friend_count, scrap_count) values(2, 4, 4, 0);
