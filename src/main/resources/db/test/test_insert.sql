...
;
-- 테스트 계정
insert into user (id, password, nickname, email, profile_image_id, user_type, created_at, updated_at, is_deleted) values
...
insert into user_count(user_id, review_count, friend_count) values(1, 4, 0);

insert into shop_count(shop_id, total_rating, rating_count) values(1,0,0)
